...
encrypt_input_word = input("Enter a word (no spaces): ")
...
# ---------- ENCRYPTION ----------
if choice == "1":
    for i in range(len(encrypt_input_list)):
        character = encrypt_input_list[i]
        if character in alphabet_list:
            ...
            encrypt_input_list[i] = alphabet_list[new_position]
        else:
...
# ---------- DECRYPTION ----------
    ...
    for i in range(len(encrypt_input_list)):
        ...
        if character in alphabet_list:
            ...
            encrypt_input_list[i] = alphabet_list[shifted_position]
        else:
            print(f"Character {character} not in alphabet list.")
